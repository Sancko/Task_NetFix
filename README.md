...
2. Write the class (calcul.rb) - 1.5 hours
3. Copy and paste part of HTML code for post and get pages (first.erb second.erb) - 0.5 hour
4. Rewriting of second.erb for initialization of cycle - 0.5 hour
